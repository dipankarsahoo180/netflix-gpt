...
const VideoTitle = ({ title, overview }) => {
   return (
      <div className="pt-[18%] px-24 absolute text-white from-black w-1/3 aspect-video max-sm:w-full max-sm:px-2 max-sm:mt-36 max-sm:bg-black  max-lg:w-full max-lg:pt-[15%]">
